...
ori_img =cv2.imread('D:/Year4/FYP/Project/train_data/digit_B/creat_data/ori_train_img.png')
print(ori_img)
...
new_trainImg_path =  'D:/Year4/FYP/Project/train_data/digit_B/data_train/'
new_testImg_path =  'D:/Year4/FYP/Project/train_data/digit_B/data_test/'

def main():
    # ori_img =cv2.imread('D:/Year4/FYP/Project/train_data/digit_B/creat_data/ori_train_img.png', cv2.IMREAD_GRAYSCALE)
    # cv2.imshow('orgainal',ori_img)
    # ret,ori_img=cv2.threshold(ori_img,100,250,cv2.THRESH_BINARY_INV)#字体变黑
    # cv2.imshow('threshold',ori_img)
    # cv2.waitKey(0)
    # cv2.destroyAllWindows()
